...
# def odejmij(a, b):
#     pass
# self reprezentuje instancję klasy. Dzięki użyciu self my możemy mieć dostęp do właściowści i metod klasy w Pythonie.
# tworzenie obiektu realizujemy przez tzw. konstruktor - jest to specjalna metoda, która jest wykonywana, kiedy tworzymy nasz obiekt. W Pythonie taka funkcję pełni metoda __init__.
class Paletka:
